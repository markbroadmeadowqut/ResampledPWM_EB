...
#define FOH_SCALE (Uint16)600 // =TBCLK/FS; both in Hz, TBCLK=60 MHz and FS corresponding to a 10us ADC conversion time
#define FOH_SCALE_doubled (Uint16)1200 // =TBCLK/FS; both in Hz, TBCLK=60 MHz and FS corresponding to a 10us ADC conversion time
#define compare_rejection_factor (Uint16)96
#endif /* CONFIG_H_ */
