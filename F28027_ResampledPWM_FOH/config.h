...
#define FOH_SCALE (Uint16)900 // =TBCLK/FS; both in Hz, TBCLK=60 MHz and FS corresponding to a 10us ADC conversion time
#define FOH_SCALE_doubled (Uint16)1800 // =TBCLK/FS; both in Hz, TBCLK=60 MHz and FS corresponding to a 10us ADC conversion time
