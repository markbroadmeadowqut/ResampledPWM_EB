...
#define CMPB_increment (int16)250 // 12.5us resampling period, but since the triggering is internal this could be reduced further
#define compare_rejection_factor (int16)42
#endif /* CONFIG_H_ */
